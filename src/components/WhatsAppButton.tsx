...
export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/910000000000?text=Greetings! I am visiting the Lala Rohini Jewellers website and would like to learn more about your heritage collections and current store offerings."
      target="_blank"
